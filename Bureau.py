...
for participant_id in df['IDParticipant'].unique():
    ...
    summary_data.append({
        ...
        'Total Time Outside in ms': total_time_outside,
        'Mean Distance per Second Inside': mean_distance_per_time_inside,
        'Mean Distance per Second Outside': mean_distance_per_time_outside,
        'Path Count': path_count
    })

# Calcul de la moyenne des moyennes et du Path Count total pour tous les participants
